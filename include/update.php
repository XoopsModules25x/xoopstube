...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_videos') . ' CHANGE url vidid TEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_videos') . ' MODIFY description LONGTEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_videos') . ' MODIFY keywords TEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_mod') . ' ADD COLUMN keywords TEXT NULL AFTER time');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_mod') . ' MODIFY description LONGTEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_mod') . ' CHANGE url vidid TEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $xoopsDB->prefix('xoopstube_mod') . ' MODIFY keywords TEXT NULL');
$ret[$i]   = $ret[$i] && $xoopsDB->query($query[$i]);
++$i;
$ret[$i]   = true;
