...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_videos') . " CHANGE url vidid TEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_videos') . " MODIFY description LONGTEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_videos') . " ADD COLUMN item_tag TEXT NOT NULL default '' AFTER keywords");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_videos') . " ADD COLUMN picurl TEXT NOT NULL default '' AFTER item_tag");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
$ret[$i]   = true;
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_videos') . " MODIFY keywords TEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " ADD COLUMN keywords TEXT NOT NULL default '' AFTER time");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " ADD COLUMN item_tag TEXT NOT NULL default '' AFTER keywords");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " ADD COLUMN picurl TEXT NOT NULL default '' AFTER item_tag");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " MODIFY description LONGTEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " CHANGE url vidid TEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
...
++$i;
$ret[$i]   = true;
$query[$i] = sprintf('ALTER TABLE ' . $GLOBALS['xoopsDB']->prefix('xoopstube_mod') . " MODIFY keywords TEXT NOT NULL default ''");
$ret[$i]   = $ret[$i] && $GLOBALS['xoopsDB']->query($query[$i]);
++$i;
$ret[$i]   = true;
