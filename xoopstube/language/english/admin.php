...
define('_AM_XTUBE_UPLOADFILE', "File Uploaded Successfully");
...
// Admin Summary
define('_AM_XTUBE_SCATEGORY', "Category:  <strong>%s</strong> ");
define('_AM_XTUBE_SFILES', "Videos:  <strong>%s</strong> ");
define('_AM_XTUBE_SNEWFILESVAL', "Submitted:  <strong>%s</strong> ");
define('_AM_XTUBE_SMODREQUEST', "Modified:  <strong>%s</strong> ");
 ...
 */
define('_AM_XTUBE_SBROKENSUBMIT', "Broken: <strong>%s</strong> ");
...
define("_AM_XTUBE_TOGGLE_OFFLINE_SUCCESS", "Video was set Offline");
define("_AM_XTUBE_TOGGLE_ONLINE_SUCCESS", "Video was set Online");
define("_AM_XTUBE_TOGGLE_FAILED", "Video Status Toggle Failed: ");
define("_AM_XTUBE_TOGGLE", "Toggle Value ");


// missing definitions
/*
_AM_XTUBE_VIDEO_EXPIREWARNING
_MD_XTUBE_COUNTRYLTOH
_MD_XTUBE_COUNTRYHTOL
